<head>
	<meta name="description" content="CL des xxx &ndash;&nbsp;politique de cookies">
</head>
...
<section class="container">
    ...
    <ul>
        <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to Japan Flights.</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Website</strong> refers to Japan Flights, accessible from <a href="https://wilfridleb.sites.3wa.io/PROJET%20FINAL/index.php?p=home" target="_blank">https://wilfridleb.sites.3wa.io/PROJET%20FINAL/index.php?p=home</a>.</p>
        </li>
        <li>
...
<section class="container">
    ...
    <?php if($session::admin()) : ?>
        <p>If you have any questions about this Cookies Policy, You can contact Us by visiting the Contact page on our website.</p>
    <?php else : ?>
        <p>If you have any questions about this Cookies Policy, You can contact Us by visiting this page on our website: <a href="https://wilfridleb.sites.3wa.io/PROJET%20FINAL/index.php?p=contactForm" target="_blank" id="contact-link">https://wilfridleb.sites.3wa.io/PROJET%20FINAL/index.php?p=contactForm</a>.</p>
	<?php endif; ?>
</section>